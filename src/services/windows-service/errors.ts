 ...
 */
export class InvalidWindowDataError extends Data.TaggedError("InvalidWindowDataError")<{
 ...
 */
export class WindowOperationFailedError extends Data.TaggedError("WindowOperationFailedError")<{
